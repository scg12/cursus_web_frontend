...
function AddMatiere(props) {
    ...
    function handleChange(e){
        ...
        matiere = (document.getElementById('libelle').value != undefined) ? document.getElementById('libelle').value.trim() : putToEmptyStringIfUndefined(document.getElementById('libelle').defaultValue).trim;        
        if(matiere.length == 0) { 
            setIsValid(false)
        } else {
            setIsValid(true)
    ...
    return (
        <div className={classes.formStyle}>
            ...
            <div>
                <input id="idMatiere" type="hidden"  value={currentUiContext.formInputs[2]}/>
            </div>
