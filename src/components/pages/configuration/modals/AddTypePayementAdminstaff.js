...
function AddTypePayementAdminstaff(props) {
    ...
    useEffect(()=> {
        ...
        console.log(createOption(currentUiContext.formInputs[6],'id','libelle_hierarchie'))
        setOpt(createOption(currentUiContext.formInputs[6],'id','libelle_hierarchie')); 
    },[])
        ...
        <div className={classes.formStyle}>
            ...
            <div className={classes.inputRowLeft}> 
                ...
                <div style={{marginBottom:'1.3vh'}}> 
                    {<select className={classes.comboBoxStyle} id="type_h" style={{color:getSelectDropDownTextColr(), width:'9.3vw',borderColor:getSelectDropDownTextColr()}}
 ...
 export default AddTypePayementAdminstaff;
