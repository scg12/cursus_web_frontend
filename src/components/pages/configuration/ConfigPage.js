                    ...
                    <MenuItemList id="conf_2" minWtdhStyle={classes.size72Vw} libelle= {t("conf_etab_struct")} theme={selectedTheme}>
                        <div  className={classes.MenuGroup}>
                            ...
                            <div className={classes.MenuItemsection} > 
                                ...
                                {(currentAppContext.enableProfiles["CONFIG_B11"]=='1') ?  <MenuItem menuItemId ='41' isSimple={true} imgSource={'images/' + getPuceByTheme()}  withCustomImage={true}  imageStyle={isMobile? M_classes.imageStyle_M : classes.imageStyle}  libelle ={t("gest_school_doc")}                  itemSelected={()=>{toggleActiveMenu('15');  (sectionSelectedItem == 0) ? setSectionSelectedItem(14): (sectionSelectedItem == 15) ? setSectionSelectedItem(0):setSectionSelectedItem(15)}}>  </MenuItem> : null}
