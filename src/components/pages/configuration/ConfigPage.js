            ...
            <div className= {getCurrentContaintTheme()}>
                    ...
                    <MenuItemList minWtdhStyle={classes.size72Vw} libelle= {t("conf_etab_struct")} theme={selectedTheme}>
                        <div className={classes.MenuGroup}>
                            <div className={classes.MenuItemsection} > 
                                ...
                                {(currentAppContext.enableProfiles["CONFIG_B5"]=='1') ?  <MenuItem menuItemId ='31'  isSimple={true} imgSource={'images/' + getPuceByTheme()}  withCustomImage={true}  imageStyle={isMobile? M_classes.imageStyle_M : classes.imageStyle}  libelle ={t("conf_exam_classes")}                                    itemSelected={()=>{toggleActiveMenu('31');   (sectionSelectedItem == 0) ? setSectionSelectedItem(31):  (sectionSelectedItem == 31)  ? setSectionSelectedItem(0):setSectionSelectedItem(31)}}>   </MenuItem> : null}
                                {(currentAppContext.enableProfiles["CONFIG_B6"]=='1') ?  <MenuItem menuItemId ='9'  isSimple={true} imgSource={'images/' + getPuceByTheme()}  withCustomImage={true}  imageStyle={isMobile? M_classes.imageStyle_M : classes.imageStyle}   libelle ={t("gest_matiere")}                            itemSelected={()=>{toggleActiveMenu('9');   (sectionSelectedItem == 0) ? setSectionSelectedItem(9):  (sectionSelectedItem == 9)  ? setSectionSelectedItem(0):setSectionSelectedItem(9)}}>   </MenuItem> : null}
                                {(currentAppContext.enableProfiles["CONFIG_B7"]=='1') ?  <MenuItem menuItemId ='10' isSimple={true} imgSource={'images/' + getPuceByTheme()}  withCustomImage={true}  imageStyle={isMobile? M_classes.imageStyle_M : classes.imageStyle}   libelle ={t('matieres_clases_config')}                               itemSelected={()=>{toggleActiveMenu('10');  (sectionSelectedItem == 0) ? setSectionSelectedItem(10): (sectionSelectedItem == 10) ? setSectionSelectedItem(0):setSectionSelectedItem(10)}}>  </MenuItem> : null}
                                {(currentAppContext.enableProfiles["CONFIG_B8"]=='1') ?  <MenuItem menuItemId ='11' isSimple={true} imgSource={'images/' + getPuceByTheme()}  withCustomImage={true}  imageStyle={isMobile? M_classes.imageStyle_M : classes.imageStyle}   libelle ={t('conf_cours_classes')}                                   itemSelected={()=>{toggleActiveMenu('11');  (sectionSelectedItem == 0) ? setSectionSelectedItem(11): (sectionSelectedItem == 11) ? setSectionSelectedItem(0):setSectionSelectedItem(11)}}>  </MenuItem> : null}
                                {(currentAppContext.enableProfiles["CONFIG_B9"]=='1') ?  <MenuItem menuItemId ='12' isSimple={true} imgSource={'images/' + getPuceByTheme()}  withCustomImage={true}  imageStyle={isMobile? M_classes.imageStyle_M : classes.imageStyle}   libelle ={t('conf_leson_group')}                                 itemSelected={()=>{toggleActiveMenu('12');  (sectionSelectedItem == 0) ? setSectionSelectedItem(12): (sectionSelectedItem == 12) ? setSectionSelectedItem(0):setSectionSelectedItem(12)}}>  </MenuItem> : null}
                                {(currentAppContext.enableProfiles["CONFIG_B10"]=='1') ?  <MenuItem menuItemId ='13' isSimple={true} imgSource={'images/' + getPuceByTheme()}  withCustomImage={true}  imageStyle={isMobile? M_classes.imageStyle_M : classes.imageStyle}  libelle ={t('gest_matricule')}                                             itemSelected={()=>{toggleActiveMenu('13');  (sectionSelectedItem == 0) ? setSectionSelectedItem(13): (sectionSelectedItem == 13) ? setSectionSelectedItem(0):setSectionSelectedItem(13)}}>  </MenuItem> : null}
                                {(currentAppContext.enableProfiles["CONFIG_B11"]=='1') ?  <MenuItem menuItemId ='14' isSimple={true} imgSource={'images/' + getPuceByTheme()}  withCustomImage={true}  imageStyle={isMobile? M_classes.imageStyle_M : classes.imageStyle}  libelle ={t("modif_etab_conf")}                       itemSelected={()=>{toggleActiveMenu('14');  (sectionSelectedItem == 0) ? setSectionSelectedItem(14): (sectionSelectedItem == 14) ? setSectionSelectedItem(0):setSectionSelectedItem(14)}}>  </MenuItem> : null}
                                {(currentAppContext.enableProfiles["CONFIG_B12"]=='1') ?  <MenuItem menuItemId ='15' isSimple={true} imgSource={'images/' + getPuceByTheme()}  withCustomImage={true}  imageStyle={isMobile? M_classes.imageStyle_M : classes.imageStyle}  libelle ={t("etab_hierarchie")}                                           itemSelected={()=>{toggleActiveMenu('15');  (sectionSelectedItem == 0) ? setSectionSelectedItem(15): (sectionSelectedItem == 15) ? setSectionSelectedItem(0):setSectionSelectedItem(15)}}>  </MenuItem> : null}
                                {(currentAppContext.enableProfiles["CONFIG_B13"]=='1') ?  <MenuItem menuItemId ='16' isSimple={true} imgSource={'images/' + getPuceByTheme()}  withCustomImage={true}  imageStyle={isMobile? M_classes.imageStyle_M : classes.imageStyle}  libelle ={t("conf_cursus_quota")}                                      itemSelected={()=>{toggleActiveMenu('16');  (sectionSelectedItem == 0) ? setSectionSelectedItem(16): (sectionSelectedItem == 16) ? setSectionSelectedItem(0):setSectionSelectedItem(16)}}>  </MenuItem> : null}
                ...
                {(currentAppContext.enableProfiles["CONFIG_C"]=='1') ? 
                    <MenuItemList minWtdhStyle={classes.size72Vw}  libelle= {t("conf_users_and_roles")} theme={selectedTheme}>
                        <div className={classes.MenuGroup}>
                            <div className={classes.MenuItemsection}>
                                {(currentAppContext.enableProfiles["CONFIG_C1"]=='1') ?  <MenuItem menuItemId ='40' isSimple={true} imgSource={'images/' + getPuceByTheme()} withCustomImage={true}  imageStyle={isMobile? M_classes.imageStyle_M : classes.imageStyle}   libelle={t('gest_users')}      itemSelected={()=>{toggleActiveMenu('40'); (sectionSelectedItem == 0) ? setSectionSelectedItem(40):(sectionSelectedItem == 40) ? setSectionSelectedItem(0):setSectionSelectedItem(40)}}> </MenuItem> : null}
                                {(currentAppContext.enableProfiles["CONFIG_C2"]=='1') ?  <MenuItem menuItemId ='32' isSimple={true} imgSource={'images/' + getPuceByTheme()} withCustomImage={true}  imageStyle={isMobile? M_classes.imageStyle_M : classes.imageStyle}   libelle={t("activate_users")}  itemSelected={()=>{toggleActiveMenu('32'); (sectionSelectedItem == 0) ? setSectionSelectedItem(32):(sectionSelectedItem == 32) ? setSectionSelectedItem(0):setSectionSelectedItem(32)}}> </MenuItem> : null}
                                {(currentAppContext.enableProfiles["CONFIG_C3"]=='1') ?  <MenuItem menuItemId ='33' isSimple={true} imgSource={'images/' + getPuceByTheme()} withCustomImage={true}  imageStyle={isMobile? M_classes.imageStyle_M : classes.imageStyle}   libelle={t("gest_ens_Spe")}    itemSelected={()=>{toggleActiveMenu('33'); (sectionSelectedItem == 0) ? setSectionSelectedItem(33):(sectionSelectedItem == 33) ? setSectionSelectedItem(0):setSectionSelectedItem(33)}}> </MenuItem> : null}
                            </div>                           
                ...
                {(currentAppContext.enableProfiles["CONFIG_D"]=='1') ? 
                    <MenuItemList minWtdhStyle={classes.size72Vw}   libelle={t("conf_payments" )} theme={selectedTheme}>
                        <div className={classes.MenuGroup}>
                            <div className={classes.MenuItemsection}>
                                {(currentAppContext.enableProfiles["CONFIG_D1"]=='1') ?  <MenuItem menuItemId ='34' isSimple={true} imgSource={'images/' + getPuceByTheme()} withCustomImage={true}  imageStyle={isMobile? M_classes.imageStyle_M : classes.imageStyle}   libelle={t('conf_payment_elv')}                             itemSelected={()=>{toggleActiveMenu('34'); (sectionSelectedItem == 0) ? setSectionSelectedItem(34):(sectionSelectedItem == 34) ? setSectionSelectedItem(0):setSectionSelectedItem(34)}}></MenuItem> : null}
                                {(currentAppContext.enableProfiles["CONFIG_D2"]=='1') ?  <MenuItem menuItemId ='35' isSimple={true} imgSource={'images/' + getPuceByTheme()} withCustomImage={true}  imageStyle={isMobile? M_classes.imageStyle_M : classes.imageStyle}   libelle={t("conf_types_paiements_autres")}                    itemSelected={()=>{toggleActiveMenu('35'); (sectionSelectedItem == 0) ? setSectionSelectedItem(35):(sectionSelectedItem == 35) ? setSectionSelectedItem(0):setSectionSelectedItem(35)}}></MenuItem> : null}
                                {(currentAppContext.enableProfiles["CONFIG_D3"]=='1') ?  <MenuItem menuItemId ='36' isSimple={true} imgSource={'images/' + getPuceByTheme()} withCustomImage={true}  imageStyle={isMobile? M_classes.imageStyle_M : classes.imageStyle}   libelle={t("conf_types_paiements_prof")}               itemSelected={()=>{toggleActiveMenu('36'); (sectionSelectedItem == 0) ? setSectionSelectedItem(36):(sectionSelectedItem == 36) ? setSectionSelectedItem(0):setSectionSelectedItem(36)}}></MenuItem> : null}
                                {(currentAppContext.enableProfiles["CONFIG_D4"]=='1') ?  <MenuItem menuItemId ='37' isSimple={true} imgSource={'images/' + getPuceByTheme()} withCustomImage={true}  imageStyle={isMobile? M_classes.imageStyle_M : classes.imageStyle}   libelle={t("conf_type_paiement_personel_Ad")}   itemSelected={()=>{toggleActiveMenu('37'); (sectionSelectedItem == 0) ? setSectionSelectedItem(37):(sectionSelectedItem == 37) ? setSectionSelectedItem(0):setSectionSelectedItem(37)}}></MenuItem> : null}
                            </div>
                ...
                {(currentAppContext.enableProfiles["CONFIG_E"]=='1') ? 
                    <MenuItemList minWtdhStyle={classes.size72Vw}  libelle= {t("conf_messages")} theme={selectedTheme}>
                        <div className={classes.MenuGroup}>
                            <div className={classes.MenuItemsection}>
                                {(currentAppContext.enableProfiles["CONFIG_E1"]=='1') ?  <MenuItem menuItemId ='38'isSimple={true}  imgSource={'images/' + getPuceByTheme()} withCustomImage={true}  imageStyle={isMobile? M_classes.imageStyle_M : classes.imageStyle}   libelle={t('budget_evolution_cf')}                                     itemSelected={()=>{toggleActiveMenu('38'); (sectionSelectedItem == 0) ? setSectionSelectedItem(38):(sectionSelectedItem == 38) ? setSectionSelectedItem(0):setSectionSelectedItem(38)}}></MenuItem> : null}
                                {(currentAppContext.enableProfiles["CONFIG_E2"]=='1') ?  <MenuItem menuItemId ='39' isSimple={true} imgSource={'images/' + getPuceByTheme()} withCustomImage={true}  imageStyle={isMobile? M_classes.imageStyle_M : classes.imageStyle}   libelle={t("interactions_evolution")}   itemSelected={()=>{toggleActiveMenu('39'); (sectionSelectedItem == 0) ? setSectionSelectedItem(39):(sectionSelectedItem == 39) ? setSectionSelectedItem(0):setSectionSelectedItem(39)}}></MenuItem> : null}
                            </div>
