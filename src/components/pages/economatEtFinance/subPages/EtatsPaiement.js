                    ...
                    <div className={classes.gridTitle} style={{marginLeft:"1vw"}}>                  
                        ...
                        <div className={classes.selectZone}>
                            ...
                            <div style ={{display:'flex', flexDirection:'row', marginLeft:'2.3vw', marginBottom:'-1vh'}}> 
                                ...
                                <input id="anne"   type="text"    Placeholder='aaaa'  onKeyUp={(e)=>{moveOnMax(e,document.getElementById("anne"), null)}}     maxLength={4}     className={classes.inputRowControl }  onChange={getYearAndCheck}style={{width:'2.7vw', fontSize:'1vw', height:'1.17vw', marginRight:'1.3vw', color:'#065386', fontWeight:'bold', marginTop:"0.3vh"}}  />
                            </div>  
