...
function StatsPresence(props){
    ...
    useEffect(()=> {
        ...
        /*---- Stats ETAB ----*/        
        drawStatPresenceEtab(currentAppContext.currentEtab);  
        drawEffectifEtabParSexe(currentAppContext.currentEtab);  

        /*---- Stats CYCLE ----*/
        drawStatPresenceParCycle(selected_cycle);  
        drawStatPresenceParCycleParSexe(selected_cycle);   

        /*---- Stats NIVEAU ----*/
        drawStatPresenceParNiveau(selected_niveau);  
        drawStatPresenceParNiveauParSexe(selected_niveau); 

        /*---- Stats CLASSE ----*/
        drawStatPresenceParClasse(selected_classe);  
        drawStatPresenceParClasseParSexe(selected_classe); 
    ...
    /******************************* Handlers *******************************/
    function drawStatPresenceEtab(etabId){
        var tabProgress=[];
        var containerDiv;
        ...
        if(etabId!= undefined){        
            getEtabProgressions(etabId).then((progressionList)=>{
                ...
                var selectedState = {
                    ...
                    datasets: [
                        {
                            label: t('overall_studChecck_evol'),
    ...
    function drawStatPresenceParCycle(cycleId){
        var tabProgress=[];
        var containerDiv;
        ...
        if(cycleId!= undefined){        
            getCycleProgressions(cycleId).then((progressionList)=>{
                ...
                var selectedState = {
                    ...
                    datasets: [
                        {
                            label: t('student_check_progress')+ ' '+ libelleCycle,
                            backgroundColor: 'rgb(72,107,218)',
                            borderColor: 'rgb(255, 255, 255)',
                            borderWidth: 2,
                            data: (tabProgress.length > 0) ? [...tabProgress[1].split('_')]:[]
    ...
    function drawStatPresenceParCycleParSexe(cycleId){
        var tabProgress=[];
        var containerDiv;
        var title = 'Effectif'+ ' en '+libelleClasse;
        if(cycleId != undefined) {
    ...
    function drawStatPresenceParNiveau(niveauId){
        var tabProgress=[];
        var containerDiv;
        ...
        if(niveauId!= undefined){        
            getNiveauProgressions(niveauId).then((progressionList)=>{
                ...
                var selectedState = {
                    ...
                    datasets: [
                        {
                            label: t('student_check_progress')+ ' ' + libelleNiveau,
                            backgroundColor: 'rgb(72,107,218)',
                            borderColor: 'rgb(255, 255, 255)',
                            borderWidth: 2,
                            data: (tabProgress.length > 0) ? [...tabProgress[1].split('_')]:[]
    ...
    function drawStatPresenceParNiveauParSexe(niveauId){
        var tabProgress=[];
        var containerDiv;
        var title = 'Effectif'+ ' en '+libelleClasse;
        if(niveauId != undefined) {
    ...
    function drawStatPresenceParClasse(classeId){
        var tabProgress=[];
        var containerDiv;
        var title = 'Effectif '+ ' en '+libelleClasse;
        ...
        if(classeId!= undefined){        
            getClasseProgressions(classeId).then((ProgressionList)=>{
                ...
                var selectedState = {
                    ...
                    datasets: [
                        {
                            label: t('student_check_progress')+ ' ' + libelleClasse,
                            backgroundColor: 'rgb(72,107,218)',
                            borderColor: 'rgb(255, 255, 255)',
                            borderWidth: 2,
                            data: (tabProgress.length > 0) ? [...tabProgress[1].split('_')]:[]
    ...
    function drawStatPresenceParClasseParSexe(classeId){
        var tabProgress=[];
        var containerDiv;
        var title = 'Effectif'+ ' en '+libelleClasse;
        if(classeId != undefined) {
...
/******************************* JSX Code *******************************/
    return (        
        <div className={classes.formStyle}>
            ...
            <FormPuce menuItemId ='1' isSimple={true} noSelect={true} imgSource={'images/' + getPuceByTheme()} withCustomImage={true} imageStyle={classes.PuceStyle}    libelle={t('evolution_presence_gen')}  itemSelected={null} puceLabelStyle={{color:"black"}}> </FormPuce> 
            ...
            <FormPuce menuItemId ='1' isSimple={true} imgSource={'images/' + getPuceByTheme()} withCustomImage={true} imageStyle={classes.PuceStyle}    libelle={t('evolution_presence_cycle')} itemSelected={null} puceLabelStyle={{color:"black"}}> </FormPuce>
            <div className={classes.inputRow + ' '+ classes.margBottom3 +' '+ classes.borderBottom}>
            ...
            <FormPuce menuItemId ='1' isSimple={true} imgSource={'images/' + getPuceByTheme()} withCustomImage={true} imageStyle={classes.PuceStyle}    libelle={t('evolution_presence_niveau')}  itemSelected={null} puceLabelStyle={{color:"black"}}> </FormPuce>
            <div className={classes.inputRow + ' '+ classes.margBottom3 +' '+ classes.borderBottom}>
