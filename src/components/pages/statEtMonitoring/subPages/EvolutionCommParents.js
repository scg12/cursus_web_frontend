...
function EvolutionCommParents(props){
        ...
        <div className={classes.formStyle}>
            <div className={classes.inputRow}> 
                <div className={classes.formTitle +' '+classes.margBottom3}>
                    TABLEAU DE BORD DE PRESENTATION DE L'EVOLUTION DE LA RELATION AVEC LES PARENTS
                </div>
            </div>
            ...
            <FormPuce menuItemId ='1' isSimple={true} noSelect={true} imgSource={'images/' + getPuceByTheme()} withCustomImage={true} imageStyle={classes.PuceStyle}    libelle="Evolution De la Relation avec les Parents Sur les 3 Dernieres Annees"  itemSelected={null}> </FormPuce>
 ...
 export default EvolutionCommParents;