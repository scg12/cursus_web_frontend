      ...
      <div className= {getCurrentContaintTheme()}>
        {(currentAppContext.enableProfiles["STATS_A"]=='1') ? 
          <MenuItemListP minWtdhStyle={classes.size72Vw} libelle= {t("acad_bilan")} theme={selectedTheme}>
            {(currentAppContext.enableProfiles["STATS_A1"]=='1') ? <MenuItemP menuItemId ='300'  imgSource='images/EvolutionEffectifs.png'    libelle={t("evolution_effectifs")}               itemSelected={showSideMenu} customImg={true} customImgStyle={isMobile ? M_classes.imgStyleP : classes.imgStyleP}></MenuItemP>  : null}
        ...
        {(currentAppContext.enableProfiles["STATS_C"]=='1') ? 
          <MenuItemListP minWtdhStyle={classes.size72Vw}  libelle= {t("non_acad_stats")} theme={selectedTheme}>
            ...
            {(currentAppContext.enableProfiles["STATS_C4"]=='1') ?  <MenuItemP menuItemId ='311' imgSource='images/statPaieProfs.png'         libelle={t("paiement_profs")}           itemSelected={showSideMenu} customImg={true} customImgStyle={isMobile ? M_classes.imgStyleP : classes.imgStyle}></MenuItemP>  : null}
          </MenuItemListP>
          :
          null
        }
