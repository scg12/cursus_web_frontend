...
function CarteScolaire(props) {
    ...
    const getEtabListClasses=()=>{
        ...
        let classes_prof = currentAppContext.infoUser.admin_classes;
        ...
        <div className={classes.formStyleP}>
            ...
            {(modalOpen==4) &&
                <PDFTemplate previewCloseHandler={closePreview}>
                    { isMobile?
                        <PDFDownloadLink  document ={<CardListTemplate pageSet={ElevePageSet}/>} fileName={printedETFileName}>
                        ...
                        <PDFViewer style={{height: "80vh" , width: "100%" , display:'flex', flexDirection:'column', justifyContent:'center',  display: "flex"}}>
                           <CardListTemplate pageSet={ElevePageSet}/>
                        </PDFViewer>
                    }
                </PDFTemplate>
            }
