      ...
      <div className= {getCurrentContaintTheme()}>
        {(currentAppContext.enableProfiles["SCOLARITE_A"]=='1') ? 
          <MenuItemListP minWtdhStyle={classes.size72Vw}  libelle= {t("enreg_admis")} theme={selectedTheme}>
            ...
            {(currentAppContext.enableProfiles["SCOLARITE_A4"]=='1') ?   <MenuItemP menuItemId ='102'  imgSource='images/certificateP.png'      libelle={t("school_certificate")}  itemSelected={showSideMenu} customImg={true} customImgStyle={isMobile ? M_classes.iconStyle : classes.customimgStyle4}> </MenuItemP> : null}
        ...
        {(currentAppContext.enableProfiles["SCOLARITE_B"]=='1') ?
          <MenuItemListP minWtdhStyle={classes.size72Vw}   libelle= {t("schedule_courses")} theme={selectedTheme}>
            ...
            {(currentAppContext.enableProfiles["SCOLARITE_B1"]=='1') ? <MenuItemP menuItemId ='107' imgSource='images/lookSchedule.png'                        libelle={t("consult_ET")}          itemSelected={showSideMenu} style={isMobile?{ marginLeft:'0.83vw'}:null} customImg={true} customImgStyle={isMobile ? M_classes.iconStyle : classes.customimgStyle4} > </MenuItemP> : null}
            {(currentAppContext.enableProfiles["SCOLARITE_B2"]=='1') ? <MenuItemP isModal={true} menuItemId ='108' imgSource='images/FicheProgession.png'      libelle={t("fiches_progression")}  itemSelected={showFicheView} customImg={true} customImgStyle={isMobile ? M_classes.iconStyle1P : classes.imgStyleP}>                                                  </MenuItemP> : null}
            {(currentAppContext.enableProfiles["SCOLARITE_B2"]=='1') ? <MenuItemP menuItemId ='109' imgSource='images/FicheProgession.png'                     libelle={t("suivi_fiche_p")}       itemSelected={showSideMenu}  customImg={true} customImgStyle={isMobile ? M_classes.iconStyle1P : classes.imgStyleP}>                                                   </MenuItemP> : null}
            {(currentAppContext.enableProfiles["SCOLARITE_B2"]=='1') ? <MenuItemP menuItemId ='110' imgSource='images/ProgramClasse.png'                       libelle={t("programmes_classes")}  itemSelected={showSideMenu}  style={isMobile?{ marginLeft:'-0.089vw'}:null} customImg={true} customImgStyle={isMobile ? M_classes.iconStyle1P : classes.imgStyleP}>   </MenuItemP> : null}
            {(currentAppContext.enableProfiles["SCOLARITE_B2"]=='1') ? <MenuItemP menuItemId ='111' imgSource='images/CahierTexte.png'                         libelle={t("cahier_textes")}       itemSelected={showSideMenu}  style={isMobile?{ marginLeft:'-0.089vw'}:null} customImg={true} customImgStyle={isMobile ? M_classes.iconStyle1P : classes.imgStyleP} >   </MenuItemP> : null}
          </MenuItemListP>
          :
          null
        }
