      ...
      <div className= {getCurrentContaintTheme()}>
        ...
        {(currentAppContext.enableProfiles["SCOLARITE_C"]=='1') ?
          <MenuItemListP minWtdhStyle={classes.size72Vw} libelle= {t("discipline_assiduite")} theme={selectedTheme}>
            ...
            {(currentAppContext.enableProfiles["SCOLARITE_C2"]=='1') ? <MenuItemP menuItemId ='113'  imgSource='images/lookPresence.png'          libelle={t("consult_appel")}            itemSelected={showSideMenu}>                                                                                            </MenuItemP> : null}
            {(currentAppContext.enableProfiles["SCOLARITE_C3"]=='1') ? <MenuItemP menuItemId ='114'  imgSource='images/ConseilDiscipline.png'     libelle={t("conseil_discipline")}       itemSelected={showSideMenu} customImg={true} customImgStyle={classes.customimgStyle3}>                                  </MenuItemP> : null}
            {(currentAppContext.enableProfiles["SCOLARITE_C4"]=='1') ? <MenuItemP menuItemId ='115'  imgSource='images/Studentprofile.png'        libelle={t("situation_eleve")}          itemSelected={showSideMenu} customImg={true} customImgStyle={isMobile ? M_classes.iconStyle4:classes.customimgStyle4}></MenuItemP> : null}
            {(currentAppContext.enableProfiles["SCOLARITE_C5"]=='1') ? <MenuItemP menuItemId ='116'  imgSource='images/BilletEntreeSortie.png'    libelle={t("exit_entry_ticket")}        itemSelected={showSideMenu} customImg={true} customImgStyle={isMobile ? M_classes.iconStyle4:classes.customimgStyle4}>                                                                                            </MenuItemP> : null}
