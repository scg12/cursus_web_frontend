   ...
   const PVText = (props) =>{
       return(
            <View style={{display:"flex", flexDirection:"column", justifyContent:"flex-start"}}>
                ...
                {/*<View style={{display:"flex", flexDirection:"row"}}>
                    <Text style={{fontSize:12,}}>sis au quartier {props.quartier}({props.ville}),un conseil de classe ({props.typeMeeting}).</Text>
                </View>
                */}
                ...
                {(props.successMark!=-1)&&
                    <View style={{display:"flex", flexDirection:"row"}}>
                        <Text style={{fontSize:12,textAlign:'justify'}}>La moyenne minimale de passage a ete fixe a:{props.successMark} </Text>
                    </View>
                }

                {(props.exclusionMark!=-1)&&
                     <View style={{display:"flex", flexDirection:"row"}}>
                         <Text style={{fontSize:12,textAlign:'justify'}}>La moyenne seuil d'exclusion a ete fixe a:{props.exclusionMark} </Text>
                    </View>
                }
