...
function ListNotesEleves(props){
    ...
    const TableHeader = (props) =>{
        return(
            <View style={props.style}>
                <View style={{width:'5vw',  justifyContent:'flex-start',...styles.headercell}}>      <Text>{props.page.tableHeaderModel[0]}</Text></View>
                <View style={{width:'10vw', justifyContent:'flex-start',...styles.headercell}}>   <Text>{props.page.tableHeaderModel[1]}</Text></View>
                <View style={{width:'37vw', paddingLeft:'3vw', justifyContent:'flex-start',...styles.headercell}}>  <Text>{props.page.tableHeaderModel[2]}</Text></View>
                <View style={{width:'8vw',  justifyContent:'flex-end',...styles.headercell}}>   <Text>{props.page.tableHeaderModel[3]}</Text></View>
            </View>
        );
    }
...
export default ListNotesEleves;